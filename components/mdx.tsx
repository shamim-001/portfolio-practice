...
const components = {
  ...
  li: ({ className, ...props }: React.HTMLAttributes<HTMLLIElement>) => <li className="mt-2" {...props} />,
  ...
  code: ({ className, ...props }: React.HTMLAttributes<HTMLElement>) => (
    <code className="relative rounded border px-[0.3rem] py-[0.2rem] font-mono text-sm" {...props} />
  ),
  Image,
}
